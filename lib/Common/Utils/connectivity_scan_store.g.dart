...
part of 'connectivity_scan_store.dart';
...
mixin _$ConnectivtyScanStore on ConnectivtyScanStoreContract, Store {
  late final _$connectivityResultAtom = Atom(
      name: 'ConnectivtyScanStoreContract.connectivityResult',
      context: context);
